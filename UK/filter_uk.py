...
headers = {
    'user-agent': 'Mozilla/5.0 (X11; CrOS x86_64 9334.33.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.51 Safari/537.36'}
proxies = {'proxy': 'http://116.212.157.23:56354'}
url0 = 'https://www.amazon.co.uk/dp/'
url1 = 'https://www.amazon.co.uk/Smiths-Edgesport-50264-Adjustable-Sharpener/product-reviews/'
url2 = '/ref=cm_cr_arp_d_viewopt_rvwer?ie=UTF8&reviewerType=avp_only_reviews&pageNumber=1&formatType=current_format'
...
def get_message(asin, list_switch):
    ...
    if r0.status_code in [304, 503] or r1.status_code in [304, 503]:
        ...
        # results.to_excel('reviewscount-uk-error.xlsx', index=False)
        sys.exit()
    else:
        pass
    ...
    results = pd.DataFrame(result)
    results.to_excel('reviewscount-uk.xlsx', index=False)
