...
# 设置列表页URL的固定部分
url1 = 'https://www.amazon.it/TOGUARD-Telecamera-registrazione-parcheggio-Rilevatore/product-reviews/'
...
for i in range(nrows):
    ...
    if i == 0:
        ...
        if r1.status_code in [304, 503]:
            ...
            reviews.to_excel('reviewscount-it-error.xlsx', index=False)
            sys.exit()
        else:
            pass
...
reviews = pd.DataFrame(results)
reviews.to_excel('reviewscount-it.xlsx', index=False)
