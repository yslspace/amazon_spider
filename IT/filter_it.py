...
url0 = 'https://www.amazon.it/dp/'
url1 = 'https://www.amazon.it/Aigostar-Sea-30CDW-Bollitore-Protezione/product-reviews/'
...
def get_message(asin, list_switch):
    ...
    for c1 in fmt_vrp_reviews:
        try:
            ...
            fmt_vrp_review = contents1.split(' ', 5)[5]
    ...
    results = pd.DataFrame(result)
    results.to_excel('reviewscount-it.xlsx', index=False)
