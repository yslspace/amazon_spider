...
url0 = 'https://www.amazon.de/dp/'
url1 = 'https://www.amazon.de/Kochmesser-Küchenmesser-Chefmesser-Allzweckmesser-Rostfreier/product-reviews/'
url2 = '/ref=cm_cr_getr_d_paging_btm_prev_1?ie=UTF8&reviewerType=avp_only_reviews&pageNumber=1&formatType=current_format'
...
def get_message(asin, list_switch):
    ...
    for c1 in fmt_vrp_reviews:
        try:
            ...
            fmt_vrp_review = contents1.split(' ', 3)[2]
    ...
    results = pd.DataFrame(result)
    results.to_excel('reviewscount-de.xlsx', index=False)
