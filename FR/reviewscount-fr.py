...
# 设置列表页URL的固定部分
url1 = 'https://www.amazon.fr/TOGUARD-Embarquée-Enregistrement-Détection-Mouvement/product-reviews/'
...
for i in range(nrows):
    ...
    if i == 0:
        ...
        if r1.status_code in [304, 503]:
            ...
            reviews.to_excel('reviewscount-fr-error.xlsx', index=False)
            sys.exit()
        else:
            pass
        ...
        for c1 in fmt_vrp_reviews:
            try:
                ...
                print(contents1)
                fmt_vrp_review = contents1.split(' ', 5)[4]
...
reviews = pd.DataFrame(results)
reviews.to_excel('reviewscount-fr.xlsx', index=False)
