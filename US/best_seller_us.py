...
url = 'https://www.amazon.com/s?k=Electric+Kettle&ref=nb_sb_noss_2'
...
for i in range(1, 100):
    ...
    if html.xpath('.//*[@id="pagnNextLink"]'):
        ...
        url = urljoin('https://www.amazon.com', next_url[0])
    ...
    asins.to_excel('best_seller_us.xlsx', index=False)
